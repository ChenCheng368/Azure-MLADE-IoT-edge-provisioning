...
export SVS_PRI_ID=   #(optional)provide service principle app ID. Do not put as string
export SVS_PRI_PW=   #(optional)provide service principle password. Do not put as string
export TENANT=   #(optional)provide Directory (tenant) ID of the service principle. Do not put as string
